...
function updateCheckoutButton() {
    ...
    // Delivery mode – check authentication first
    if (!token) {
        btn.disabled = true;
...
// ============================================================
//  DELIVERY ESTIMATION – AUTOMATED FLOW
// ============================================================
async function recalcDeliveryFee(showFeedback = true) {
    ...
    const btn = document.getElementById('checkout-btn');
    if (btn) { btn.disabled = true; btn.textContent = '⏳ Calculating...'; btn.classList.add('opacity-50'); }
    try {
...
// ============================================================
//  ADDRESS SUGGESTIONS (GPS & OSM) – with auto‑estimate
// ============================================================
...
async function checkout() {
    ...
    // If method is moniepoint, block (coming soon)
...
// ============================================================
//  PAYMENT RETURN HANDLER (with receipt)
// ============================================================
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    // Address & GPS (with auto‑estimate)
    const addrInput = document.getElementById('delivery-address');
